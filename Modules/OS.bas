...
'PhotoPaint can automatically recover sessions interrupted by forced system reboots.  This function
...
'Return a unique session ID for this PhotoPaint instance.  A session ID is generated by retrieving a
' random GUID, hashing it, then returning the first 12 characters from the hash.  So many random steps
' are not necessary, but they help ensure that the IDs are actually unique.
Public Function UniqueSessionID() As String
    
    If (LenB(m_SessionID) = 0) Then
