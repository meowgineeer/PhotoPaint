VERSION 5.00
Begin VB.UserControl pdTreeviewOD 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   ClientHeight    =   3600
   ClientLeft      =   0
   ...
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   320
   ToolboxBitmap   =   "pdTreeviewOD.ctx":0000
   Begin PhotoPaint.pdScrollBar vScroll 
      ...
      _ExtentY        =   2778
   End
   Begin PhotoPaint.pdTreeviewViewOD lbView 
      Height          =   1575
      Left            =   360
      TabIndex        =   0
      Top             =   360
   ...
   End
End
Attribute VB_Name = "pdTreeviewOD"
