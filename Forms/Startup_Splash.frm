...
Public Sub PrepareRestOfSplash()
    ...
    If m_dibsLoadedSuccessfully Then
        ...
        ' Create a solid premium dark-mode background: charcoal gray (RGB 32, 32, 32)
        ...
        titleFont.SetFontSize 42
        titleFont.SetFontBold True
        ...
        titleH = titleFont.GetHeightOfString(titleStr)
        
        Dim titleDIB As pdDIB
        Set titleDIB = New pdDIB
        titleDIB.CreateBlank titleW, titleH, 24, vbBlack
        
        titleFont.SetFontColor vbWhite
        titleFont.AttachToDC titleDIB.GetDIBDC
        titleFont.FastRenderText 0, 0, titleStr
        titleFont.ReleaseFromDC
        Set titleFont = Nothing
        
        titleDIB.ConvertTo32bpp
        Dim titleAlpha() As Byte
        ...
        ' Render a clean drop shadow for text by drawing black title shifted by FixDPI(2)
        Dim titleShadowDIB As pdDIB
        Set titleShadowDIB = New pdDIB
        titleShadowDIB.CreateBlank titleW, titleH, 32, vbBlack, 150
        DIBs.ApplyTransparencyTable titleShadowDIB, titleAlpha
        titleShadowDIB.SetAlphaPremultiplication True
        
        ' Render onto splash canvas at centered Y and slightly offset X
