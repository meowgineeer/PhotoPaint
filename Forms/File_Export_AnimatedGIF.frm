VERSION 5.00
Begin VB.Form dialog_ExportAnimatedGIF 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   ...
   EndProperty
   HasDC           =   0   'False
   Icon            =   "File_Export_AnimatedGIF.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   482
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   804
   ...
   End
End
Attribute VB_Name = "dialog_ExportAnimatedGIF"
...
' *not* reflect all current export settings - lossy settings in particular are cost-prohibitive to
